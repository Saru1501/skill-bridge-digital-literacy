...
// Component 4 pages (Sponsorship/Payment)
...
function App() {
  return (
    <Routes>
      ...
      {/* Component 4 — Student (Sponsorship/Payments) */}
      ...
      {/* Gamification */}
      <Route path="/student/gamification" element={<ProtectedRoute allowedRoles={["student"]}><GamificationDashboard /></ProtectedRoute>} />
      ...
      {/* Component 1 + 2 — Student learning routes */}
      ...
      <Route element={<ProtectedRoute allowedRoles={["admin","university"]}><AppLayout /></ProtectedRoute>}>
