    ...
    <div className="flex min-h-screen bg-[#f8f9fc]">
      ...
      <aside className="w-72 fixed inset-y-0 left-0 bg-white border-r border-gray-100 shadow-sm z-20 flex flex-col">
        <div className="p-6">
          ...
          <p className="text-xs font-bold uppercase tracking-widest text-indigo-400 ml-11">Student Portal</p>
        </div>
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-1.5">
          ...
          <NavLink to="/student/programs" className={linkClass}>
          ...
          <NavLink to="/student/apply" className={linkClass}>
            <Send size={20} />
            <span>Apply for Sponsorship</span>
          </NavLink>
          <NavLink to="/student/redeem" className={linkClass}>
            <KeyRound size={20} />
            <span>Redeem Code</span>
          </NavLink>
          <NavLink to="/student/tickets" className={linkClass}>
            <LifeBuoy size={20} />
            <span>Support Tickets</span>
          </NavLink>
          <NavLink to="/student/payment" className={linkClass}>
            <CreditCard size={20} />
            <span>Payments</span>
          </NavLink>
        </nav>
      ...
      <main className="flex-1 ml-72 flex flex-col min-h-screen overflow-x-hidden">
        ...
        <header className="sticky top-0 z-10 backdrop-blur-md bg-white/70 border-b border-gray-100 px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-extrabold text-indigo-600 capitalize bg-indigo-50 px-2 py-0.5 rounded-md">{user?.role}</span>
          </div>
          <div className="flex items-center gap-2">
