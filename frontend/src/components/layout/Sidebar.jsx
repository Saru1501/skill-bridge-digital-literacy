...
const studentLinks = [
  ...
  { to: "/assessment", label: "Assessments",
    icon: <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2M9 5a2 2 0 012-2h2a2 2 0 012 2M9 5a2 2 0 002 2h2a2 2 0 002-2m-6 9l2 2 4-4"/></svg> },
  { to: "/saved",      label: "Saved Courses",
    icon: <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"/></svg> },
...
const adminLinks = [
  ...
  { to: "/admin/courses",    label: "Manage Courses",
    icon: <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg> },
  { to: "/admin/assessment", label: "Assessments",
    icon: <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2M9 5a2 2 0 012-2h2a2 2 0 012 2M9 5a2 2 0 002 2h2a2 2 0 002-2m-6 9l2 2 4-4"/></svg> },
    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        {(isAdmin ? adminLinks : studentLinks).map(l => (
          <NavLink key={l.to} to={l.to} end={l.to === "/admin" || l.to === "/dashboard"}
        ...
        {!isAdmin && (
          <>
            <div className="sidebar-section" style={{marginTop:8}}>
              <p className="sidebar-label">Rewards & Support</p>
            </div>
            {studentExtras.map(l => (
              <NavLink key={l.to} to={l.to} end={l.to === "/student"}
                className={({ isActive }) => "nav-item" + (isActive ? " active" : "")}>
                {l.icon}
                <span>{l.label}</span>
              </NavLink>
