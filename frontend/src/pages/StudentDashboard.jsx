    ...
    <div className="space-y-6">
      <div className="rounded-2xl bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-gray-600">
          Manage your sponsorship applications, support requests, and payments from here.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-white p-6 shadow-sm text-left">
        ...
        <p className="mt-3 text-gray-600">
          Start by browsing available sponsorship programs, applying for support, or checking your tickets.
        </p>
